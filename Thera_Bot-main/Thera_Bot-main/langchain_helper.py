...
def create_vector_db():
    ...
    loader = CSVLoader(file_path='Mental_Health_FAQ.csv', source_column="prompt")
    data = loader.load()
...
def get_qa_chain():
    ...
    If the answer is not found in the context, kindly state "I'm sorry I can't help you with that." Don't try to make up an answer.
